    ...
    <div className="flex flex-col min-h-screen bg-white text-gray-800">
      ...
      <section className="w-full mt-24 mb-4 px-4 flex justify-center items-center bg-white relative overflow-hidden">
        <div className="flex flex-col md:flex-row justify-center items-center gap-12">
          {/* Alternative Modern Hero Card */}
          <div className="relative bg-gradient-to-br from-[#034694] via-[#023a7a] to-[#001450] rounded-[2rem] shadow-[0_20px_60px_rgba(3,70,148,0.3)] backdrop-blur-sm px-24 py-14 flex flex-col justify-center items-start min-w-[600px] max-w-4xl overflow-hidden">
            ...
            <div className="relative z-10">
              <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4 drop-shadow-xl tracking-tight leading-tight">
                Experience effortless home-cooked meals without the stress.
              </h1>
              <p className="text-lg md:text-xl text-white mb-6 font-medium leading-snug">
                Avoid the grocery run. Have fresh handpicked recipes delivered straight to your kitchen, tailored to your cravings!
              </p>
              <button
                onClick={handleViewRecipesClick}
                className="bg-white/20 backdrop-blur-sm border border-white/30 text-white font-bold py-4 px-12 rounded-full shadow-lg transition-all duration-300 hover:bg-white/30 hover:scale-105 text-lg hover:shadow-xl"
              >
                Explore Recipes  
              </button>
            </div>
          ...
          <img
            src="src\assets\images\biteboxmeal.png"
            alt="Hero"
